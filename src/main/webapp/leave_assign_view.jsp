...
<head>
    ...
    <title>Manage Faculty Assignments</title>
    <!-- Font Links -->
...
<body>
    ...
    <table>
        ...
        <c:forEach var="assign" items="${leave_faculty_assign}">
            <tr>
                <td>${assign.sl_no}</td>   
                <td>${assign.name}</td>
                ...
                <td>
                    <form method="post" action="assignmanage">
                        <input type="hidden" name="sl_no" value="${assign.sl_no}" />
